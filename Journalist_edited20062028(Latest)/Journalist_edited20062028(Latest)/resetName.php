...
<div class="container">
	 ...
	 <h3 align = "center">First name and Last name updated successfully</h3>
...
$sql = "UPDATE User SET fName=('$_POST[fName]') WHERE username=('$username')";
$conn->query($sql);
$sql = "UPDATE User SET lName=('$_POST[lName]') WHERE username=('$username')";
$conn->query($sql);
